<footer>
                            ...
                            <ul class="icon_list">
                                <li>
                                    <a>
                                        ...
                                        <p class="text_li">
                                            <span class="phone_footer">Hotline: 0765-506-710</span>
                                            <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                        </p>
                                    </a>
                                </li>
                                <div class="clear"></div>
                                <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  Nam@gmail.com</a></li>
                ...
                <div class="footer">
                    ...
                    <div class="footer-col">
                        ...
                        <div class="infor_footer">
                            <address>
                        <address>Địa Chỉ : 32 Trần việt châu, P. An hòa, Q. Ninh kiều, TP. Cần thơ<br />
                           Điện thoại: 0765-506-710<br />
                           Email: Nam@gmail.com
                        </address>
                            </address>
                        </div>
        ...
        <div class="clear"></div>
        <div class="copyright">
            <h4 class="tkw9999">&copy;  © Bản quyền thuộc về Nam. Designed by Nam</h4>
        </div>
    </footer>
